# Generated by Django 3.2 on 2024-12-20 21:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(db_index=True, validators=[django.core.validators.MinValueValidator(0, message='Неккоректное значение - год не может быть до н.э.'), django.core.validators.MaxValueValidator(2024, message='Неккоректное значение - вы указыаете еще не наступивший год')], verbose_name='Год выхода')),
